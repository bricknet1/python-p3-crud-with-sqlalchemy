...
if __name__ == '__main__':
    ...
    students_alt = session.query(Student).all()
    print(students_alt)
    ...
    oldest_student_alt = session.query(Student.name, Student.birthday).order_by(Student.birthday).first()
    print(oldest_student_alt)
